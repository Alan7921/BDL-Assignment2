...
contract MatchingPennies {
    ...
    enum State { waitPlayers, makeDecision, verification, roundover }
   ...
   */
    function join(uint8 seatNumber) public payable {
        ...
        require ( msg.value >= 1 ether,"If you want to join the game, the least jetton required is 1 ether.");
        ...
        players[msg.sender].playerBalance += msg.value;
  ...
  */
    function announcement() public returns(string memory result) {
        require(gameState == State.roundover,
  ...
  */
    function nextRound() public {
        ...
        require(players[msg.sender].playerBalance >=1 ether,
  ...
  */
    function Bwin() internal returns (string memory) {
        players[playersAddr[0]].playerBalance -= 1 ether;
        players[playersAddr[1]].playerBalance += 0.8 ether;
  ...
  */
    function Awin() internal returns (string memory) {
        players[playersAddr[1]].playerBalance -= 1 ether;
        players[playersAddr[0]].playerBalance += 0.8 ether;
        contractBalance += 0.2 ether;
        dataReset();
