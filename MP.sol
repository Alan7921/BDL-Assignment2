...
contract MatchingPennies {
    ...
    // hand fee
    uint256 public constant HAND_FEE = 0.1 ether;
    ...
    function join(uint8 seatNumber) public payable {
        ...
        require(
            ...
            "If you want to join the game, the least jetton required is 1.1 ether."
        );
        require(
            numberOfCurrentPlayers < 2,
            "There are already two players, please wait for next round."
        );
    ...
    function sendCommitment(bytes32 commitment) public {
        ...
        require(
            ...
            "You have sent your commitment, please do not send it twice and wait for other player."
        );
    ...
    function verify(string calldata origin) public {
        ...
        if (
            players[msg.sender].choice != 0x31 &&
            players[msg.sender].choice != 0x30
        ) {
    ...
    function announcement() public returns (string memory result) {
        ...
        if (cheatState == ViolationState.noCheat) {
            ...
            return
                "B wins the game because PlayerA cheated in this round, and has been fined with all his/her money in contract.";
            ...
            return
                "A wins the game because PlayerB cheated in this round, and has been fined with all his/her money in contract.";
        } else if (cheatState == ViolationState.bothCheat) {
            Nowinner();
            return
                "Both two sides choose to cheat in this round, all their money are fined.";
        }
    }
    ...
    function nextRound() public {
        ...
        require(
            msg.sender == playersAddr[0] || msg.sender == playersAddr[1],
            "You are not in the game, please wait for space."
        );

        require(
            players[msg.sender].playerBalance >= JETTON,
